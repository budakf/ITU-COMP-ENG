...
def pdf_plot_hist(listee):
	plt.hist(listee[0])
	plt.title("histograms of the matched image BLUE")
	plt.show()
	plt.hist(listee[1])
	plt.title("histograms of the matched image GREEN")
	plt.show()
	plt.hist(listee[2])
	plt.title("histograms of the matched image RED")
	plt.show()
...
file_name		= "remapped.png"



l1 = color_x(file_name)
pdf_plot_hist(l1)